...
slider && dragElement(container, btn);

/*  play button  */
circle && playBtn.addEventListener('click', function(e) {
  e.preventDefault();
...
/*  play button  */
searchInput && searchInput.addEventListener('change', function(e) {
  e.preventDefault();
...
/*  play button  */
formInput && formInput.addEventListener('change', function(e) {
  e.preventDefault();
